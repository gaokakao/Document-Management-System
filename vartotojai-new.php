...
if (isset($_POST['submit']))
{
	...
	else if ($lygis != 'none')
	{
		...
		{
			$query = "SELECT * FROM asmenys WHERE vartotojo_vardas = '".$vartotojo_vardas."' LIMIT 1";
	...
	if (strlen($error) == 0)
	{
		$query = "INSERT INTO asmenys (vardas, pavarde, pareigos, vartotojo_vardas, slaptazodis, lygis, email) VALUES ('".$vardas."', '".$pavarde."', '".$pareigos."', '".$vartotojo_vardas."', '".$slaptazodis."', '".$lygis."', '".$email."')";
...
<tr bgcolor="#DDDDDD">
	<td colspan="2"><b>Naujas vartotojas</b></td>
</tr>
<tr bgcolor="#FFFFFF">
	<td align="right">
...
document.vartotojai.vardas.focus();
</script>