...
"
 ...
 >
 	...
 	<input type="button" value="R DISKAS"  onclick="window.location = '/shared.php';">	</div>
...
>
		...
		<input type="button" value="ATSIJUNGTI"  onclick="window.location = '/logout.php';">		</div>
...
">
	...
	<form action="upload.php" method="post" enctype="multipart/form-data">
		...
		<input type="file" name="Upload" value="Upload" id="Upload" multiple="multiple">
		<input type="hidden" name="dest" value="users"> <br>
		<input type="submit" value="IKELTI" name="submit">
