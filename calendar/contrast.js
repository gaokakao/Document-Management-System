...
// ---- Common Options ----
var gMonths=["Sausis","Vasaris","Kovas","Balandis","Gegužė","Birželis","Liepa","Rugpjūtis","Rugsėjis","Spalis","Lapkritis","Gruodis"];
var gWeekDay=["S","P","A","T","K","Pn","Š"];	// weekday caption from Sunday to Saturday

var gBegin=[1990,1,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
var gEnd=[2199,12,31];	// calendar date range end at [Year,Month,Date]
var gsOutOfRange="Atsiprašome, negalima pasirinkti šios datos!";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gcCalBG="#a4d277";	// the background color of the outer calendar panel.
...
var gcBGToday="lightgreen";	// the background color for today
...
var gsTodayTip="Šiandien";	// tooltip for today
