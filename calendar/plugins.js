...
gsBottom=(NN4?"":"<DIV class='BottomDiv'>")+"<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"Šiandienos pasirinkti neįmanoma!\");return false;' onmouseover='return true;' >Šiandien : "+gMonths[gToday[1]-1]+" "+gToday[2]+", "+gToday[0]+"</A><BR><A class='BottomAnchor' href='javascript:void(0)' onclick='if(this.blur)this.blur();fClearSelected();return false;' onmouseover='return true;'>Išvalyti</A>"+(NN4?"":"</DIV>");
